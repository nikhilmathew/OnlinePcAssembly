<?php
include'layout.php';
$_SESSION['system']['cabinet']=$_GET['part'];
?>
<html>
<head>
...
<div class="main">
				...
				<h3 style="float:left;">Processors</h3>
					<div class="cbp-vm-options">
						<a href="#" class="cbp-vm-icon cbp-vm-grid cbp-vm-selected" data-view="cbp-vm-view-grid">Grid View</a>
						<a href="#" class="cbp-vm-icon cbp-vm-list" data-view="cbp-vm-view-list">List View</a>
					</div>
					<form action="customizeram.php" method="post">
					<ul>
						<?php

					
					$result=mysqli_query($conn,"select * from parts_inventory where type='cpu' and socket='".$_SESSION['mbd']['socket']."'");
