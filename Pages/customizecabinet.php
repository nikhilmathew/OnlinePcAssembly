...
$motherboardid=$_POST['part'];
$_SESSION['system']['motherboard']=$_POST['part'];

$result=mysqli_query($conn,"select * from motherboard_inventory where id=".$motherboardid."");
...
<div class="main">
				...
				<h3 style="float:left;">cabinets</h3><form action="customizecpu.php" method="get"> 
					...
					$result=mysqli_query($conn,"select * from parts_inventory where type='cab' and ff='".$_SESSION['mbd']['ff']."'");
