...
$dbselected_id= $_GET['selected_id'];
		$sql1=mysqli_query($conn,"delete From acc_inventory where pid='".$dbselected_id."'");
		$sql2=mysqli_query($conn,"delete From inv_id_gen where id='".$dbselected_id."'");
		$sql3=mysqli_query($conn,"delete From shopping_cart where pid='".$dbselected_id."'");
...
$retid = $reid['userid'];
$dbselected_id= $_GET['selected_id'];
		$sql1=mysqli_query($conn,"delete From acc_inventory where id='".$dbselected_id."'");
