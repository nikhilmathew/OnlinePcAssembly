...
<form action="../login/retailerregister.php" method="post"><!-- onSubmit="return passcheck()"-->
...
<span> enter a password  &nbsp;&nbsp;	<input id="pass1" type="password" name ="Password" placeholder="Enter your password" style="border-radius:7px; border:2px solid #2B2525;"></span><br>
